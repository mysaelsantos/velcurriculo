...
const ResumeForm: React.FC<ResumeFormProps> = ({
  ...
  return (
    <React.Fragment>
      ...
      <div id="form-wizard" style={{ scrollMarginTop: '9rem' }} className="w-full lg:w-1/3 bg-white p-6 rounded-lg shadow-md form-container max-h-[calc(100vh-8rem)] overflow-y-auto">
        {!isFinished && (
