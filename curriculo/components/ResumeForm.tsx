                ...
                {(showSecondPhone || data.personalInfo.whatsappPhone) && (
                  <div className="animate-fade-in">
                    <div className="relative">
                      ...
                      <input
                        type="tel"
                        placeholder="WhatsApp (usado no QR Code)"
                        className="w-full p-2 pl-9 pr-10 border rounded-md bg-white border-gray-300 text-gray-900 border-green-200 focus:border-green-400 focus:ring-green-400"
