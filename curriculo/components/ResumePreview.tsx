...
const ResumePreview = forwardRef<ResumePreviewRef, ResumePreviewProps>(({ data, isDemoMode, isFirstPage, isMeasurement, hideEmptySections, isPrint }, ref) => {
  ...
  // CORREÇÃO: Em vez de um spacer flutuante, aplicamos padding no container.
  // Isso garante que elementos Flexbox (como cabeçalhos de data) respeitem o espaço.
  const getContainerStyle = (itemId: string) => {
      ...
      return { 
          ...
          width: '100%' // Garante que o container ocupa toda a largura para o padding funcionar
      };
  };
    ...
    <div id="resume-preview" ref={previewRef} className={containerClasses}>
      ...
      <main className="space-y-4" style={getMainStyle()}>
        ...
        <section id="languages-section">
            ...
            {/* CORREÇÃO: Removida a classe 'block' para evitar conflito com 'flex' e permitir que o padding funcione corretamente */}
