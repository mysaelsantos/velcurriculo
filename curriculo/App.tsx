                ...
                <section id="features" className="py-20 bg-gradient-to-b from-gray-50 to-white">
                    <div className="container mx-auto px-4 max-w-6xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {/* Card 1: IA */}
                            <div className="scroll-reveal reveal-up reveal-delay-1 group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl hover:border-blue-200 transition-all duration-300 hover:-translate-y-1">
                            ...
                            {/* Card 2: ATS */}
                            <div className="scroll-reveal reveal-up reveal-delay-2 group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl hover:border-green-200 transition-all duration-300 hover:-translate-y-1">
                            ...
                            {/* Card 3: Tempo Real */}
                            <div className="scroll-reveal reveal-up reveal-delay-3 group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl hover:border-purple-200 transition-all duration-300 hover:-translate-y-1">
                            ...
                            {/* Card 4: PDF */}
                            <div className="scroll-reveal reveal-up reveal-delay-4 group bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl hover:border-orange-200 transition-all duration-300 hover:-translate-y-1">
