...
// DADOS DE DEMONSTRAÇÃO - MANTIDOS 100% IGUAIS
...
const App: React.FC = () => {
    ...
    // --- CORREÇÃO LOCALSTORAGE: Salva sempre que não for o modo DEMO ---
    useEffect(() => {
    ...
    const calculatePagination = useCallback(async (dataToPaginate: ResumeData) => {
        ...
        // PADDING DE SEGURANÇA MANTIDO, MAS SEM EXAGEROS
        const qrPadding = 20; 
        ...
        for (let i = 0; i < blocks.length; i++) {
            ...
            if (overlapsDangerZone) {
                ...
                // === LÓGICA INTELIGENTE DE RIGOR ===
                // Se o texto colide com o QR Code, ele é espremido. A largura diminui ~40%, 
                // então a altura aumenta proporcionalmente. Aplicamos um fator de 1.4x 
                // na altura medida para simular esse crescimento e forçar a quebra de página
                // se o novo tamanho "simulado" ultrapassar o limite.
