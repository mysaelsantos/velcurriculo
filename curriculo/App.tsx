...
const App: React.FC = () => {
    ...
    // --- FUNÇÕES DE EXCLUSÃO (DECLARADAS APENAS AQUI) ---
    ...
    const calculatePagination = useCallback(async (dataToPaginate: ResumeData) => {
        ...
        for (let i = 0; i < blocks.length; i++) {
            ...
            if (overlapsDangerZone) {
                ...
                // Multiplicador de segurança para o texto espremido
    ...
    return (
        ...
        {isDevModeActive && (
            <>
                ...
                {/* BOTÃO PARA PREENCHER DADOS DE DEMO */}
                <button
                    type="button"
